...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, RGB_TOG, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, BL_TOGG, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
